DROP VIEW IF EXISTS [dbo].[VW_DTRDataEntry]

/****** Object:  View [dbo].[VW_DTRDataEntry]    Script Date: 02/03/2020 11:44:53 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[VW_DTRDataEntry] AS
SELECT
  A.TRAN_CODE
 ,A.OR_NO 'REFERENCE'
...
WHERE DATEDIFF(DAY, A.BUSINESS_DATE, (SELECT CURRENT_BUSINESS_DATE FROM CMN.BANK_SUNDRY)) = 0
  AND A.IS_REVERSAL <> 1
  AND A.USER_NAME NOT IN ('SYS') --DTR
GO
