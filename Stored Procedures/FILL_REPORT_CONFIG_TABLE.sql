...
DROP PROCEDURE IF EXISTS dbo.FILL_REPORT_CONFIG_TABLE
...
CREATE PROCEDURE dbo.FILL_REPORT_CONFIG_TABLE
	@HEADER_ID BIGINT,
	@BUSINESS_DATE DATE,
	@IS_COMPLETED INT = 0,
	@SP_NAME NVARCHAR(50) = 'FILL_REPORT_CONFIG_TABLE',
	@TABLE_NAME NVARCHAR(100) = 'RPT.REPORT_CONFIGURATION_TABLE',
